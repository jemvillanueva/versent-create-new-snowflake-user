...
#   python3 sql-api-generate-jwt.py
...
class JWTGenerator(object):
    ...
    def __init__(self, account: Text, user: Text, bucket: Text, obj_key: Text,
        ...
        :param account: Your Snowflake account identifier. See
        https://docs.snowflake.com/en/user-guide/admin-account-identifier.html. Note that if you are using the
    ...
    def get_token(self) -> Text:
        """
        Generates a new JWT. If a JWT has been already been generated earlier, return the previously generated token
        unless the
...
def lambda_handler(event, lambda_context):
    ...
    # deserialize the private key into bytes
    ...
    conn = snowflake.connector.connect(
        ...
        authenticator=str_authenticator,
        private_key=pkb,
